          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-300 text-sm">
                Intrinsicly streamline multidisciplinary infomediaries after
                competitive niche markets. Continually seize high standards in
                models with fully tested platforms. Compellingly morph granular
                users after just in time total linkage. Efficiently customize
            ...
            <div>
              ...
              <div className="space-y-4">
                <p className="text-gray-300 text-sm">
                  14 Street, nirala, Khulna
                </p>
                <p className="text-gray-300 text-sm">contact@echoshop.com</p>
                <p className="text-gray-300 text-sm">+880 19XX XXXXXX</p>
              </div>
            </div>
          </div>
        </div>
